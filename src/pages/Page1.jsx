...
const Page1 = () => {
    ...
    "
            ...
            "
                    ...
                    <div className="flex w-full flex-col md:flex-row justify-between gap-70">
                        ...
                        <motion.div
                            ...
                            transition={{ duration: 0.8, ease: "easeOut" }}
                        >
                            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight leading-tight hidden md:block">
                                Hey, <br />
                                I’m{" "}
                        ...
                        >
                            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight leading-tight md:hidden block">
                                Hey, <br />
                                I’m{" "}
                                <span className="relative inline-block text-[#FFD41D] italic cursor-default">
                                    <motion.span
                            ...
                            <p className="text-lg font-bold text-left mt-6 md:mt-90">
